<template>
    <v-card outlined>
        ...
        <v-card-text>
            ...
            <div>
                <String label="IndexId" v-model="item.indexId" :editMode="editMode" @change="change" />
            </div>
            <div>
                <Date label="NotifiedDt" v-model="item.notifiedDt" :editMode="editMode" @change="change" />
            </div>
        </v-card-text>
